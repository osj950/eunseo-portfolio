...
const ALL_WORKS = [
  { cat: "web" as WorkCat,        thumb: "yellow" as ThumbVariant, icon: "🌱", tag: "홈페이지", title: "거침없는 우다다학교",   desc: "Next.js + Google Sheets 연동. 게시판, 후원 신청, 갤러리 포함.",    href: "https://udada-school.vercel.app", external: true },
  { cat: "web" as WorkCat,        thumb: "brown"  as ThumbVariant, icon: "🌿", tag: "홈페이지", title: "한국타말파연구소",       desc: "Nuxt.js 기반 웹사이트. 프로그램 안내, 갤러리, 신청 폼 포함.",       href: "#",                              external: false },
  { cat: "translate" as WorkCat,  thumb: "red"    as ThumbVariant, icon: "✍️", tag: "번역",    title: "표현예술치료 강의 번역", desc: "SP 및 표현예술치료 관련 한영 번역 작업.",                           href: "#",                              external: false },
  { cat: "video" as WorkCat,      thumb: "dark"   as ThumbVariant, icon: "🎬", tag: "영상",    title: "교육 소개 영상",         desc: "수업 스케치, 강사, 교육생 장면 구성의 5분 분량 영상.",              href: "#",                              external: false },
  { cat: "embroidery" as WorkCat, thumb: "brown"  as ThumbVariant, icon: "🧵", tag: "자수",    title: "프랑스자수 작품 01",     desc: "손으로 천천히 만드는 시간의 기록.",                                href: "#",                              external: false },
];
            ...
            <div className="all-work-grid">
              {filtered.map((item, i) => (
                <a
                  ...
                  style={{ border: "1px solid rgba(107,66,38,0.08)", borderRadius: 14, overflow: "hidden", transition: "transform 0.2s", textDecoration: "none", display: "block" }}
                  onMouseEnter={(e) => (e.currentTarget.style.transform = "translateY(-4px)")}
                  onMouseLeave={(e) => (e.currentTarget.style.transform = "translateY(0)")}
                >
                  <div style={{ aspectRatio: "16/9", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 48, background: THUMB_BG[item.thumb] }}>
                    {item.icon}
                  </div>
